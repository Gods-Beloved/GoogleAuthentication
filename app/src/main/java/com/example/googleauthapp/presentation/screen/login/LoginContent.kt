...
import com.example.googleauthapp.components.GoogleButton
import com.example.googleauthapp.components.MessageBar
...
@Composable
fun CentralContent(signedInState: Boolean, onButtonClicked: () -> Unit) {
    Image(
        modifier = Modifier
